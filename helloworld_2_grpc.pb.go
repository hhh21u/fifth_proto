...
type GreeterClient interface {
	...
	GetContainers(ctx context.Context, in *GetNames, opts ...grpc.CallOption) (*PrintReply, error)
}
...
func (c *greeterClient) GetContainers(ctx context.Context, in *GetNames, opts ...grpc.CallOption) (*PrintReply, error) {
	out := new(PrintReply)
	err := c.cc.Invoke(ctx, "/main.Greeter/GetContainers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GreeterServer interface {
	...
	GetContainers(context.Context, *GetNames) (*PrintReply, error)
...
func (UnimplementedGreeterServer) GetContainers(context.Context, *GetNames) (*PrintReply, error) {
...
func _Greeter_GetContainers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetNames)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GreeterServer).GetContainers(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/main.Greeter/GetContainers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreeterServer).GetContainers(ctx, req.(*GetNames))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Greeter_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Greeter_GetContainers_Handler,
		},
	},
